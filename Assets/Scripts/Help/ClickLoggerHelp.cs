...
public class ClickLoggerHelp : MonoBehaviour
{
    [Serializable]
    ...
    {
        // 카테고리 값
        string foodCategoryStr = CategoryController.GetCategory(MenuName.Help, index, "ko");
        PlayerPrefs.SetString("Category", foodCategoryStr);
        ...
        clickEvent.button_name = foodCategoryStr;
        clickEvent.category_1 = "Help";
        clickEvent.category_2 = foodCategoryStr;
