...
public class MoveToEventDetailScene : MonoBehaviour
{
    [SerializeField]
    private string eventDetailScene;
    [SerializeField]
    private TextMeshProUGUI eventId;

    [SerializeField]
    private string shoppingDetailScene;
    [SerializeField]
    private TextMeshProUGUI shoppingNo;
    ...
    {
        PlayerPrefs.SetString("eventId", eventId.text);
        SceneManager.LoadScene(eventDetailScene);
    ...
    {
        string No = PlayerPrefs.GetString("eventId");
