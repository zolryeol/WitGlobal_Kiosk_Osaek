...
public class MoveToShoppingDetailScene : MonoBehaviour
{
    [SerializeField]
    ...
    {
        PlayerPrefs.SetString("shoppingNo", shoppingNo.text);
        SceneManager.LoadScene(shoppingDetailScene);
    ...
    {
        string No = PlayerPrefs.GetString("shoppingNo");
        ...
        clickEvent.category_1 = "Shopping";
