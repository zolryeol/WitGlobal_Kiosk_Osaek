...
public class ClickLoggerGogoong : MonoBehaviour
{
    [Serializable]
    ...
    public void Start()
    {
        //Debug.LogError("ClickLoggerGogoong!!!!!");

        GameObject contentObject = GameObject.Find("Canvas/Body/Content");

        Button[] buttons = contentObject.GetComponentsInChildren<Button>();
        //Debug.LogError($"Found {buttons.Length} buttons under Content!");
    ...
    public void ParameterMatch(int index)
    {
        ...
        Debug.LogError($"index : {index} Str : {CategoryStr}");
