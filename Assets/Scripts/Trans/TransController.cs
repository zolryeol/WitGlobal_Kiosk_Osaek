...
{
    [SerializeField]
    private GameObject publicTrans;
    [SerializeField]
    private GameObject insaMap;
    [SerializeField]
    ...
    public void Awake()
    {
        ...
        ls.transSceneInit();
        Dictionary<string, Dictionary<string, string>> res = ls.languageChange("trans");
        ...
        // 번역 끝나면 요소 숨기기
        publicTrans.SetActive(false);
        insaMap.SetActive(false);
