...
public class MoveToMuseumDetailScene : MonoBehaviour
{
    [SerializeField]
    private string museumDetailScene;
    [SerializeField]
    private TextMeshProUGUI museumNo;
    ...
    {
        PlayerPrefs.SetString("museumNo", museumNo.text);
        SceneManager.LoadScene(museumDetailScene);
    ...
    {
        string No = PlayerPrefs.GetString("museumNo");
