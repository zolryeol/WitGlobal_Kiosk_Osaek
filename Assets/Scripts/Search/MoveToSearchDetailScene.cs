...
public class MoveToSearchDetailScene : MonoBehaviour
{
    [SerializeField]
    private string searchDetailScene;
    [SerializeField]
    private TextMeshProUGUI searchNo;
    ...
    {
        PlayerPrefs.SetString("searchNo", searchNo.text);
        SceneManager.LoadScene(searchDetailScene);
    ...
    public void ParameterCheck()
    {
        ...
        clickEvent.category_1 = "Search";
        clickEvent.category_2 = category;
        clickEvent.store_no = PlayerPrefs.GetString("searchNo");
