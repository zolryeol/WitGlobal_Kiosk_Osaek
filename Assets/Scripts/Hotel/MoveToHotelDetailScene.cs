...
public class MoveToHotelDetailScene : MonoBehaviour
{
    [SerializeField]
    private string hotelDetailScene;
    [SerializeField]
    private TextMeshProUGUI hotelNo;
    ...
    {
        PlayerPrefs.SetString("hotelNo", hotelNo.text);
        SceneManager.LoadScene(hotelDetailScene);
    ...
    {
        string No = PlayerPrefs.GetString("hotelNo");
